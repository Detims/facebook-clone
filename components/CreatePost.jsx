  ...
  return (
    <div className='bg-white rounded-md shadow-md text-gray-500 p-2'>
        ...
        <div className='flex justify-evenly py-2'>
            <div className='flex items-center p-1 space-x-1 grow justify-center hover:bg-gray-100 rounded-md hover:cursor-pointer'>
                <HiOutlineVideoCamera size={20} className='text-red-500' />
                <p className='font-semibold text-gray-600'>Live Video</p>
            </div>
            <div onClick={handleClick} className='flex items-center p-1 space-x-1 grow justify-center hover:bg-gray-100 rounded-md hover:cursor-pointer'>
                <IoMdPhotos size={20} className='text-green-500' />
                <p className='font-semibold text-gray-600'>Photo/Video</p>
                <input onChange={addImageToPost} type='file' ref={hiddenFileInput} file hidden accept='image/*'></input>
            </div>
            <div className='flex items-center p-1 space-x-1 grow justify-center hover:bg-gray-100 rounded-md hover:cursor-pointer'>
